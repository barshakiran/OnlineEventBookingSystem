...
namespace TestHelper
{
        ...
        public class DataInitializerEventDetail
    {
        ...
        public class DataInitializerUserEventDetails : DataInitializerEventDetail
        {
            public static List<UserEventDetailsDomainModel> GetAllUserEventDetailDomainModel()
            {
                DateTime eventDate = new DateTime(2021, 11, 30, 5, 10, 20);
        ...
        public class DataInitializerBookedEventDetail : DataInitializerUserEventDetails
        {
            public static List<BookingDetailDomainModel> GetAllBookedEventDetailDomainModel()
            {
                ...
                List<BookingDetailDomainModel> newBookedEventList = new List<BookingDetailDomainModel>
              {
                  new BookingDetailDomainModel { Booking_Id =1001,UserName = "TestUser",Event_Id= 101,Email= "testc@123",Booking_TicketCount= 3,
                                      Booking_TotalAmount = 900,IsConfirmationSent = true,Payment_Mode= "Debit Card", Booking_Date = eventDate}
              };
        ...
        public class DataInitializerAPIEventDetailModels
        {
            public static List<EventDetailModel> GetAllEventDetailModel()
            {
                DateTime eventDate = new DateTime(2021, 11, 30, 5, 10, 20);
                List<EventLocationModel> newEventList = new List<EventLocationModel>
                  {
                      new EventLocationModel { Location_Id =10,City="Bangalore",EventLocation_Price= 200,EventLocation_DateAndTime= eventDate},
                      new EventLocationModel { Location_Id =11,City="Delhi",EventLocation_Price= 300,EventLocation_DateAndTime= eventDate}
                  };


                var eventData = new List<EventDetailModel>()
                    {
        ...
        public class DataInitializerAPIUserDetailModels
    {
        public static List<UserRegistrationModel> GetAllUserDetailModel()
        {
            var dbdata = new List<UserRegistrationModel>()
            {
        ...
        public class DataInitializerAPIUserEventDetailModels: DataInitializerAPIEventDetailModels
        {
            public static List<UserEventDetailsModel> GetAllUserEventBookingDetailModel()
            {
                DateTime eventDate = new DateTime(2021, 11, 30, 5, 10, 20);
                List<UserEventDetailsModel> newBookedEventList = new List<UserEventDetailsModel>
                  {
                      new UserEventDetailsModel { Booking_Loc ="Bangalore",EventLocation_Price= 300,Booking_Date = eventDate}
                  };
        ...
        public class DataInitializerAPIBookingDetailModels : DataInitializerAPIUserEventDetailModels
        {
            public static List<BookingDetailModel> GetAllBookedEventDetailModel()
            {
                DateTime eventDate = new DateTime(2021, 11, 30, 5, 10, 20);


                List<BookingDetailModel> newBookedEventList = new List<BookingDetailModel>
                  {
                      new BookingDetailModel { Booking_Id =1001,UserName = "TestUser",Event_Id= 101,Email= "testc@123",Booking_TicketCount= 3,
                                          Booking_TotalAmount = 900,IsConfirmationSent = true,Payment_Mode= "Debit Card", Booking_Date = eventDate}
                  };
